        ...
        <PageSkeleton>
            <div className="main__anchor">
                <div className='main__text--top'>
                    ...
                    <h4>
                        {language.firstStep1}
                        <span className='main__text--span'>print('Hello Alem!')</span>
                        {language.firstStep2}
                    </h4>
                ...
                <div className='main__optional'>
                    <div className='main__learn'>
                        <div className="main__optional--header">{language.toLearn}</div>
                        <div className='main__learn__block__anchor'>
                            <div className='main__learn__block'>
                                <img className="main__learn__img--circled" src={freecodecamp} alt='freecodecamp'></img>
                                <div className='main__learn__block__text' >
                                    <div >{language.learnHtml}</div>
                                    <div>{language.learnHtmlText}</div>
                                </div>
                            </div>
                            <a href='https://www.freecodecamp.org/learn/2022/responsive-web-design/learn-html-by-building-a-cat-photo-app/' target='_blank' rel='noreferrer'>
                                {language.startLearn}
                            </a>
                        </div>
                        <div className='main__learn__block__anchor'>
                            <div className='main__learn__block'>
                                <img className="main__learn__img--medium" src={hackkerrank} alt='freecodecamp'></img>
                                <div className='main__learn__block__text' >
                                    <div >{language.learnPython}</div>
                                    <div>{language.learnPythonText}</div>
                                </div>
                            </div>
                            <a href='https://www.hackerrank.com/domains/python?filters%5Bstatus%5D%5B%5D=unsolved&badge_type=python' target='_blank' rel='noreferrer'>
                                {language.startLearn}
                            </a>
                        </div>
                    </div>
